		...
		<div id="listdiv1">
			<table>
				...
				<tr>
					...
					%>
					<a href="../abc/qna_board/detail.jsp?bno=<%=vo.getBno() %>"><%=vo.getBtitle() %></a>
					<%
					
					}else if(pw1!=null){
						
					%>
					[비밀글]<a href="../abc/qna_board/passwordcheck.jsp?bno=<%=vo.getBno() %>"><%=vo.getBtitle() %></a>
					<%
					}
					%>
				...
				<tr>
					...
					<a href="../abc/qna_boardwrite.jsp"><input type="button" value="글쓰기" width="20px"/></a>
					</td>
				</tr>
