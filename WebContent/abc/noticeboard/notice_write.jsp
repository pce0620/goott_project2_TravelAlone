	...
	<form action="notice_writeOk.jsp" name="frm">
		<div id="contents1">
			<table>
				<tr class="line">
					<th id="col1">제목</th>
					<td id="td1"><input type="text" name="btitle" id="btitle" width="400"/></td>
				</tr>
				<tr class="line">
					<th id="col1">작성자</th>
					<td id="td1"><input type="text" name="mname" id="mname" width="200"/></td>
				</tr>
				<tr>
					<td colspan="2" id="td1">
				...
				<tr class="line">
					<td colspan="2" id="td1">
						<a href="notice_list.jsp"><input type="button" value="목록" id="list"/></a>
