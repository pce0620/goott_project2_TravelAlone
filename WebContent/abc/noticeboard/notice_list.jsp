...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		$('.bt').click(function(){	
			var bno = this.value;
			$('#listdiv1').load('../abc/noticeboard/notice_detail.jsp?bno='+bno);
			//console.log("click");
		});
		$('.write').click(function(){
			$('#board').load('../abc/noticeboard/notice_write.jsp');
		});
			...
			<table id="noticelistTable">
				...
				<tr>
					<td colspan="4">
						...
						%>
						<a href="../abc/noticeboard/notice_list.jsp?cp=<%=i %>"><span id="page"> <%=i %></span></a>			
						<%
							}//if end
						}//for end
						%>
				...
				<tr>
					...
					<a href="../abc/noticeboard/notice_write.jsp"><button value="공지글등록" class="write">공지글등록</button></a>
