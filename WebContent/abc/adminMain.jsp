...
<body>
  ...
  <div id="top">
  	...
  	<div id="top2">
	    <img src="../abcImg/mainLogo3.png" alt="" id="logo"/>
    </div>
    <div id="top3">
    </div>
  </div>
	...
	<div class="sidenav">
	   <button class="dropdown-btn">
	    ...
	    <div class="dropdown-container">
	      ...
	      <a href="adminMain.jsp?fno=boardManage">고객센터 관리</a>
	      <a href="adminMain.jsp?fno=boardManage2">커뮤니티 관리</a>
	    </div>
	     <button class="dropdown-btn">
	    ...
	    <div class="dropdown-container">
	      <a href="adminMain.jsp?fno=salesAnalysis">매출 분석</a>
	      <a href="adminMain.jsp?fno=productAnalysis">상품 분석</a>
	    </div>
